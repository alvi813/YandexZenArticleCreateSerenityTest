...
public class CreatingArticleSteps {
    ...
    @When("the user create an article with title '$title', with text '$text', with image which has path '$absoluteImagePath' and with caption under the image '$captionText'")
    public void whenTheUserCreateAnArticleWith(String title, String text, String ImagePath, String captionUnderTheImageText) {
        endUserSteps.createArticle(title, text, ImagePath, captionUnderTheImageText);
    }
