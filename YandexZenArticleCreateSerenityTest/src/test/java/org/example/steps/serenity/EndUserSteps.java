...
public class EndUserSteps {
    ...
    public void openPublicationPage() {
        articleCreationPage.open();
    }

    // Перейти на пустую страницу создания статьи:
    @Step
    public void goToBlankCreatingArticlePage() {
        articleCreationPage.clickNewPublicationButton();
        articleCreationPage.clickNewTextPublicationButton();
    }

    // Ввести заголовок, текст абзаца, вставить картинку и подпись под картинкой:
    @Step
    public void fillInCreatingArticlePage(String title, String text, String ImagePath, String captionText) {
        ...
        articleCreationPage.sendAbsoluteImagePathToFileInputElement(ImagePath);
    ...
    @Step
    public void createArticle(String title, String text, String absoluteImagePath, String captionUnderTheImageText) {
        ...
        fillInCreatingArticlePage(title, text, absoluteImagePath, captionUnderTheImageText);
    }
